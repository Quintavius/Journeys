...
namespace Voxeland5 
{
	public class InstanceRandom
	{
		...
		public InstanceRandom (CoordRect rect, int seed, int gloabalSeed, int lutLength=100) 
		{ 
			//TODO: find a better way to generate seed
			this.seed = seed + 12345 + (int)(1000f*rect.offset.x/rect.size.z) + (int)(1f*rect.offset.z/rect.size.z);
